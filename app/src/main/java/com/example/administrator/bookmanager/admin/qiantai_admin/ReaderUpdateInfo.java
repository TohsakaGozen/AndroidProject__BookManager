...
public class ReaderUpdateInfo extends AppCompatActivity {
...
//                values.put("user", struser);
                ...
                Toast.makeText(ReaderUpdateInfo.this, "信息修改成功", Toast.LENGTH_LONG).show();
            }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ReaderUpdateInfo.this,contentActivity.class);
